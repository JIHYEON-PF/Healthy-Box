...
public class OiOrderStatusContent extends AuditingFields {
    ...
    public OiOrderStatusContent(String orderNo, String sellerCode, String division, String title, String content) {
    ...
    public static OiOrderStatusContent of(String orderNo, String sellerCode, String division, String title, String content) {
        return new OiOrderStatusContent(orderNo, sellerCode, division, title, content);
    }
    ...
    public boolean equals(Object o) {
        ...
        return orderNo.equals(that.orderNo) && sellerCode.equals(that.sellerCode) && division.equals(that.division) && title.equals(that.title) && content.equals(that.content);
    }
